...
| Dark / flat calibration | **File → Load Dark Frame...** / **Load Flat Field...** / **Calibration Wizard…** (PT **Carregar Dark Frame...** / **Carregar Flat Field...** / **Assistente de Calibração…**) | Masters can be built in the Calibration dock ("Build Master…"). Calibration is applied inside Run Data Reduction. |
