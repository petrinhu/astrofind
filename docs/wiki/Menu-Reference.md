...
AstroFind 1.2.2. You do not need to read it from top to bottom: use it like a dictionary. Each
...
do AstroFind 1.2.2. Não precisa ler de cima a baixo: use como um dicionário. Cada item traz o
...
- The main window title is `AstroFind 1.2.2` when the program starts. After you save or open a
...
- A barra de menus tem oito menus, nesta ordem: **Arquivo, Editar, Ferramentas de Astrometria,
  ...
  **Janelas**) para não quebrar os links de outras páginas; a coluna "PT label" sempre mostra o
  texto atual na tela.
- O título da janela principal é `AstroFind 1.2.2` quando o programa abre. Depois de salvar ou
