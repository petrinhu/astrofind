...
🇬🇧 **English**
No. AstroFind runs only on **Linux**. Version 1.2.1 is tested on Ubuntu 24.04, Debian 12,
...
🇧🇷 **Português**
Não. O AstroFind roda apenas no **Linux**. A versão 1.2.1 é testada no Ubuntu 24.04, Debian 12,
...
1. The AstroFind version from **Help → About AstroFind…** ("Version 1.2.1", for example), or
...
1. A versão do AstroFind em **Ajuda → Sobre o AstroFind…** (por exemplo "Versão 1.2.1"), ou
